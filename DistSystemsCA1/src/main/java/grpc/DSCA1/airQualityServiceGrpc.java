...
public final class airQualityServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<grpc.DSCA1.IndexRankNumber,
      grpc.DSCA1.IndexRankRating> getGetAirQualityIndexMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getAirQualityIndex",
      requestType = grpc.DSCA1.IndexRankNumber.class,
      responseType = grpc.DSCA1.IndexRankRating.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<grpc.DSCA1.IndexRankNumber,
      grpc.DSCA1.IndexRankRating> getGetAirQualityIndexMethod() {
    io.grpc.MethodDescriptor<grpc.DSCA1.IndexRankNumber, grpc.DSCA1.IndexRankRating> getGetAirQualityIndexMethod;
      ...
      synchronized (airQualityServiceGrpc.class) {
        if ((getGetAirQualityIndexMethod = airQualityServiceGrpc.getGetAirQualityIndexMethod) == null) {
          airQualityServiceGrpc.getGetAirQualityIndexMethod = getGetAirQualityIndexMethod = 
              io.grpc.MethodDescriptor.<grpc.DSCA1.IndexRankNumber, grpc.DSCA1.IndexRankRating>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "airQualityService", "getAirQualityIndex"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.DSCA1.IndexRankNumber.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.DSCA1.IndexRankRating.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<grpc.DSCA1.GasType,
      grpc.DSCA1.PollutionResult> getPollutantCalculationMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "pollutantCalculation",
      requestType = grpc.DSCA1.GasType.class,
      responseType = grpc.DSCA1.PollutionResult.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<grpc.DSCA1.GasType,
      grpc.DSCA1.PollutionResult> getPollutantCalculationMethod() {
    io.grpc.MethodDescriptor<grpc.DSCA1.GasType, grpc.DSCA1.PollutionResult> getPollutantCalculationMethod;
      ...
      synchronized (airQualityServiceGrpc.class) {
        if ((getPollutantCalculationMethod = airQualityServiceGrpc.getPollutantCalculationMethod) == null) {
          airQualityServiceGrpc.getPollutantCalculationMethod = getPollutantCalculationMethod = 
              io.grpc.MethodDescriptor.<grpc.DSCA1.GasType, grpc.DSCA1.PollutionResult>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "airQualityService", "pollutantCalculation"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.DSCA1.GasType.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.DSCA1.PollutionResult.getDefaultInstance()))
  ...
  public static abstract class airQualityServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getAirQualityIndex(grpc.DSCA1.IndexRankNumber request,
        io.grpc.stub.StreamObserver<grpc.DSCA1.IndexRankRating> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<grpc.DSCA1.GasType> pollutantCalculation(
        io.grpc.stub.StreamObserver<grpc.DSCA1.PollutionResult> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                grpc.DSCA1.IndexRankNumber,
                grpc.DSCA1.IndexRankRating>(
  ...
  public static final class airQualityServiceBlockingStub extends io.grpc.stub.AbstractStub<airQualityServiceBlockingStub> {
     ...
     * </pre>
     */
    public grpc.DSCA1.IndexRankRating getAirQualityIndex(grpc.DSCA1.IndexRankNumber request) {
  ...
  public static final class airQualityServiceFutureStub extends io.grpc.stub.AbstractStub<airQualityServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<grpc.DSCA1.IndexRankRating> getAirQualityIndex(
        grpc.DSCA1.IndexRankNumber request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_AIR_QUALITY_INDEX:
          serviceImpl.getAirQualityIndex((grpc.DSCA1.IndexRankNumber) request,
              (io.grpc.stub.StreamObserver<grpc.DSCA1.IndexRankRating>) responseObserver);
          break;
        default:
  ...
  private static abstract class airQualityServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return grpc.DSCA1.AirQualityServiceImpl.getDescriptor();
    }
