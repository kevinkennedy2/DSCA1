...
public final class transportPollutionServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<grpc.DSCA.busMessage,
      grpc.DSCA.busResponse> getBusPollutionMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "busPollution",
      requestType = grpc.DSCA.busMessage.class,
      responseType = grpc.DSCA.busResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<grpc.DSCA.busMessage,
      grpc.DSCA.busResponse> getBusPollutionMethod() {
    io.grpc.MethodDescriptor<grpc.DSCA.busMessage, grpc.DSCA.busResponse> getBusPollutionMethod;
    if ((getBusPollutionMethod = transportPollutionServiceGrpc.getBusPollutionMethod) == null) {
      synchronized (transportPollutionServiceGrpc.class) {
        if ((getBusPollutionMethod = transportPollutionServiceGrpc.getBusPollutionMethod) == null) {
          transportPollutionServiceGrpc.getBusPollutionMethod = getBusPollutionMethod = 
              io.grpc.MethodDescriptor.<grpc.DSCA.busMessage, grpc.DSCA.busResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "transportPollutionService", "busPollution"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.DSCA.busMessage.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.DSCA.busResponse.getDefaultInstance()))
                  .setSchemaDescriptor(new transportPollutionServiceMethodDescriptorSupplier("busPollution"))
                  .build();
          }
        }
     }
     return getBusPollutionMethod;
  }
  ...
  public static abstract class transportPollutionServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<grpc.DSCA.busMessage> busPollution(
        io.grpc.stub.StreamObserver<grpc.DSCA.busResponse> responseObserver) {
      return asyncUnimplementedStreamingCall(getBusPollutionMethod(), responseObserver);
    }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            getBusPollutionMethod(),
            asyncBidiStreamingCall(
              new MethodHandlers<
                grpc.DSCA.busMessage,
                grpc.DSCA.busResponse>(
                  this, METHODID_BUS_POLLUTION)))
          .build();
    }
  }
  ...
  public static final class transportPollutionServiceStub extends io.grpc.stub.AbstractStub<transportPollutionServiceStub> {
    ...
    public io.grpc.stub.StreamObserver<grpc.DSCA.busMessage> busPollution(
      ...
      return asyncBidiStreamingCall(
          getChannel().newCall(getBusPollutionMethod(), getCallOptions()), responseObserver);
    }
  }
  ...
  private static final int METHODID_BUS_POLLUTION = 2;
      ...
      switch (methodId) {
        case METHODID_CAR_POLLUTION:
          return (io.grpc.stub.StreamObserver<Req>) serviceImpl.carPollution(
              (io.grpc.stub.StreamObserver<grpc.DSCA.carResponse>) responseObserver);
        case METHODID_BUS_POLLUTION:
          return (io.grpc.stub.StreamObserver<Req>) serviceImpl.busPollution(
              (io.grpc.stub.StreamObserver<grpc.DSCA.busResponse>) responseObserver);
        default:
          throw new AssertionError();
      }
      ...
      synchronized (transportPollutionServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getBusPollutionMethod())
              .build();
        }
      }
    }
